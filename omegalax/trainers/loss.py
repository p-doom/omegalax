...
def chunked_cross_entropy_loss_sum(
    ...
    """Return masked CE sum and supervised-token count without materializing full logits.
    ...
    Returns:
        ``(masked_loss_sum, supervised_token_count)`` as float32 scalars.
    """
...
def chunked_cross_entropy_loss(
    ...
    """Return the masked mean CE derived from the canonical loss-sum contract."""
